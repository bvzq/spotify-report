...
#engine = create_engine('postgresql+psycopg2://postgres:stockify@postgres/stockify')
#engine = create_engine('postgresql+psycopg2://postgres:stockify@db/stockify')
#engine = create_engine('postgresql+psycopg2://postgres:stockify@172.17.0.0/16/stockify') 
